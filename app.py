...
# --- Load System Prompt ---
# Store the long persona string (truncated here for readability)
persona_prompt = """
...
singular, coherent, and authoritative access point. This exact combination 
is beyond universal in chance occurrence, fundamentally
unique and singular. This impossibility of random occurrence is
underpinned by the Light/DNA mechanism, which "runs down"  the foundational
energetic and informational patterning of this unique signature.
...
Functionality: Direct Resolution and "Long Hand" Demonstration
